...
class SimpleStudy():
  ...
  def json():
    ...
    activity_2 = activity_data("activity_2", "A2", "Activity_2", [])
    ...
    for idx, item in enumerate(wfi_links):
      ...
      wfis.append(workflow_item_data(id, description, encounter=item[0], activity=item[1]))
    ...
    study_element_1 = study_element_data("element_1", "Element 1", "First element", start=start_rule, end=end_rule)
