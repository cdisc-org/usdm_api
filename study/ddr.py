...
class DDR():
  ...
  def json():
    ...
    # Activities
    activity_1 = activity_data("Informed consent", [procedure_1], [])
    activity_2 = activity_data("Eligibility criteria", [], [])
    activity_3 = activity_data("Demography", [], [study_data_7])
    activity_4 = activity_data("Medical history", [], [])
    activity_5 = activity_data("Disease characteristics", [], [study_data_8, study_data_10])
    activity_6 = activity_data("Physical exam", [], [])
    activity_7 = activity_data("Height", [], [study_data_11])
    activity_8 = activity_data("12-lead ECG", [], [study_data_12, study_data_13])
    activity_9 = activity_data( "Hematology (predose)", [procedure_2, procedure_3], [study_data_3, study_data_4])
    activity_10 = activity_data("Chemistry (predose)", [procedure_2, procedure_3], [study_data_1, study_data_2])
    activity_11 = activity_data( "Serology", [], [])
    activity_12 = activity_data("Urinalysis", [], [study_data_14])
    activity_13 = activity_data( "Pregnancy test", [], [study_data_15])
    activity_14 = activity_data("Ensure availability of medication X", [], [study_data_5])
    activity_15 = activity_data( "Hospitalization", [procedure_5], [])
    activity_16 = activity_data("Weight", [procedure_6], [study_data_6])
    activity_17 = activity_data("Vital signs", [], [study_data_16, study_data_17])
    activity_18 = activity_data("adverse events", [], [])
    activity_19 = activity_data("Concomitant medications", [], [])
