...
class DDR():
  ...
  def json():
    ...
    # Activities
    activity_1 = activity_data("Informed consent", 1, [procedure_1], [])
    activity_2 = activity_data("Eligibility criteria", 2, [], [])
    activity_3 = activity_data("Demography", 3, [], [study_data_7])
    activity_4 = activity_data("Medical history", 4, [], [])
    activity_5 = activity_data("Disease characteristics", 5, [], [study_data_8, study_data_10])
    activity_6 = activity_data("Physical exam", 6, [], [])
    activity_7 = activity_data("Height", 7, [], [study_data_11])
    activity_8 = activity_data("12-lead ECG", 8, [], [study_data_12, study_data_13])
    activity_9 = activity_data("Hematology (predose)", 9, [procedure_2, procedure_3], [study_data_3, study_data_4])
    activity_10 = activity_data("Chemistry (predose)", 10, [procedure_2, procedure_3], [study_data_1, study_data_2])
    activity_11 = activity_data("Serology", 11, [], [])
    activity_12 = activity_data("Urinalysis", 12, [], [study_data_14])
    activity_13 = activity_data("Pregnancy test", 13, [], [study_data_15])
    activity_14 = activity_data("Ensure availability of medication X", 14, [], [study_data_5])
    activity_15 = activity_data("Hospitalization", 15, [procedure_5], [])
    activity_16 = activity_data("Weight", 16, [procedure_6], [study_data_6])
    activity_17 = activity_data("Vital signs", 17, [], [study_data_16, study_data_17])
    activity_18 = activity_data("adverse events", 18, [], [])
    activity_19 = activity_data("Concomitant medications", 19, [], [])
